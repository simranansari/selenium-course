...
public class Day3 {
	...
	// values those are specific to particular test folder then u should define inside the test folder in Xml file.
	...
	// By using Dataprovider here-u r saying ur test to go & catch the dataprovider which have a name called getData
	// & get the whole data as a variable & run it in ur test.
	...
	// It helps to run test with multiple combinations
	@DataProvider
